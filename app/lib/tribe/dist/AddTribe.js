...
var EditTribe = function (_a) {
    var tribeId = _a.tribeId, onTribeUpdate = _a.onTribeUpdate, onTribeAdded = _a.onTribeAdded;
    ...
    var fetchTribeDetails = function () { return __awaiter(void 0, void 0, void 0, function () {
        var res, result, fetchedTribeDetails, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch("/api/people?id=" + encodeURIComponent(tribeId), {
                            method: "GET",
                ...
                case 3:
                    result = _a.sent();
                    fetchedTribeDetails = result.person;
    ...
    var updatePeople = function (values) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    return [4 /*yield*/, fetch("/api/tribe", {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                ...
                case 4:
                    ...
                    if (result.person._id && !tribeId) {
                        onTribeAdded === null || onTribeAdded === void 0 ? void 0 : onTribeAdded(result.person);
